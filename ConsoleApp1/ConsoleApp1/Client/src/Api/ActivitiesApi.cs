...
namespace IO.Swagger.Api
{
    ...
    public class ActivitiesApi : IActivitiesApi
    {
        ...
        /// <param name="commute">Set to 1 to mark as commute.</param> 
        /// <returns>DetailedActivity</returns>            
        public DetailedActivity CreateActivity (string name, string type, DateTime? startDateLocal, int? elapsedTime, string description, float? distance, int? trainer, int? commute)
        {
